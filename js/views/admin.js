...
window.filterU = filterU // CORRIGIDO: Exposta a função de busca de usuários globalmente
window.closeModalGod = close // CORRIGIDO: Exposta a função de fechar o modal sob um nome seguro
