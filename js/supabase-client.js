...
export const sb = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
  ...
  // ⚠️ IMPORTANTE: Não force fetch personalizado
  // Deixe o Supabase usar o fetch padrão do navegador
})
...
export async function testConnection(retries = 5, delay = 1000) {
  console.log(`🔄 Testando conexão com Supabase... (${retries} tentativas restantes)`)
...
// ============================================================
// FUNÇÕES DE ACESSO AO BANCO COM RETRY
// ============================================================
